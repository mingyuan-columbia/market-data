"""CLI entry point for Stage A Alpaca IEX extraction."""
...
from .stage_a_alpaca_iex import extract_stage_a_alpaca_iex
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Extract historical IEX feed data from Alpaca API",
    ...
    logger.info(f"Symbols to extract: {len(symbols)}")
    
    # Parse dates
    if args.date:
        # Single date
        trade_date = date.fromisoformat(args.date)
        results = extract_stage_a_alpaca_iex(
            config=config,
