...
def check_csv_exists(csv_root: Path, trade_date: date, data_type: str, prefix: str) -> Path | None:
    """
    ...
    Args:
        ...
        prefix: CSV file prefix (e.g., "taq_trade")
        
    Returns:
        Path to CSV file if exists, None otherwise
    """
    date_str = trade_date.strftime("%Y%m%d")
    csv_path = csv_root / f"{prefix}_{date_str}.csv"
